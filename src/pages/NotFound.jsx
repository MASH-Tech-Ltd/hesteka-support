    ...
    <div className="flex-1 flex flex-col items-center justify-center w-full h-full animate-fade-in p-4">
      <div className="bg-white p-10 md:p-14 text-center shadow-[0_20px_50px_rgba(0,0,0,0.05)] relative overflow-hidden flex flex-col items-center" style={{ borderRadius: '2rem', border: '1px solid #ebd8c3', width: '100%', maxWidth: '32rem' }}>
        ...
        <div className="w-24 h-24 bg-yellow-50 rounded-full flex items-center justify-center mb-6 shadow-inner">
          <HelpCircle size={50} className="text-yellow-600" strokeWidth={2} />
        </div>
        <h2 className="text-2xl sm:text-3xl text-red-600 mb-4 uppercase tracking-wider drop-shadow-sm whitespace-nowrap" style={headingFont}>404 - {t('pageNotFound')}</h2>
        <p className="text-base md:text-lg font-medium opacity-75 mb-8 text-[#3a2a1a]">{t('pageNotFoundDesc')}</p>
